...
#ifndef SPACEXPANSEGAME_SQLITESTORAGE_HPP
#define SPACEXPANSEGAME_SQLITESTORAGE_HPP
 ...
 *
 * The storage implementation here uses tables with prefix "spacexpansegame_".
...
#endif // SPACEXPANSEGAME_SQLITESTORAGE_HPP
