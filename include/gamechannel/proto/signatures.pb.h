...
// source: gamechannel/proto/signatures.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_gamechannel_2fproto_2fsignatures_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_gamechannel_2fproto_2fsignatures_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_gamechannel_2fproto_2fsignatures_2eproto
...
struct TableStruct_gamechannel_2fproto_2fsignatures_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gamechannel_2fproto_2fsignatures_2eproto;
namespace xaya {
namespace proto {
class SignedData;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::xaya::proto::SignedData* Arena::CreateMaybeMessage<::xaya::proto::SignedData>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xaya {
namespace proto {
...
class SignedData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xaya.proto.SignedData) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:xaya.proto.SignedData)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_gamechannel_2fproto_2fsignatures_2eproto;
};
// ===================================================================
...
inline const std::string& SignedData::data() const {
  // @@protoc_insertion_point(field_get:xaya.proto.SignedData.data)
...
void SignedData::set_data(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.data_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xaya.proto.SignedData.data)
}
inline std::string* SignedData::mutable_data() {
  std::string* _s = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:xaya.proto.SignedData.data)
  return _s;
}
...
inline std::string* SignedData::release_data() {
  // @@protoc_insertion_point(field_release:xaya.proto.SignedData.data)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xaya.proto.SignedData.data)
}
...
inline std::string* SignedData::add_signatures() {
  ...
  // @@protoc_insertion_point(field_add_mutable:xaya.proto.SignedData.signatures)
  return _s;
}
...
inline const std::string& SignedData::signatures(int index) const {
  // @@protoc_insertion_point(field_get:xaya.proto.SignedData.signatures)
  return _internal_signatures(index);
}
inline std::string* SignedData::mutable_signatures(int index) {
  // @@protoc_insertion_point(field_mutable:xaya.proto.SignedData.signatures)
...
inline void SignedData::set_signatures(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:xaya.proto.SignedData.signatures)
}
...
inline void SignedData::set_signatures(int index, const char* value) {
  ...
  _impl_.signatures_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:xaya.proto.SignedData.signatures)
}
inline void SignedData::set_signatures(int index, const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:xaya.proto.SignedData.signatures)
}
...
inline void SignedData::add_signatures(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:xaya.proto.SignedData.signatures)
}
...
inline void SignedData::add_signatures(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.signatures_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:xaya.proto.SignedData.signatures)
}
inline void SignedData::add_signatures(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:xaya.proto.SignedData.signatures)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
SignedData::signatures() const {
  // @@protoc_insertion_point(field_list:xaya.proto.SignedData.signatures)
  return _impl_.signatures_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
SignedData::mutable_signatures() {
  // @@protoc_insertion_point(field_mutable_list:xaya.proto.SignedData.signatures)
  return &_impl_.signatures_;
}
...
inline const std::string& SignedData::for_testing_version() const {
  // @@protoc_insertion_point(field_get:xaya.proto.SignedData.for_testing_version)
...
void SignedData::set_for_testing_version(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.for_testing_version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xaya.proto.SignedData.for_testing_version)
}
inline std::string* SignedData::mutable_for_testing_version() {
  std::string* _s = _internal_mutable_for_testing_version();
  // @@protoc_insertion_point(field_mutable:xaya.proto.SignedData.for_testing_version)
  return _s;
}
...
inline std::string* SignedData::release_for_testing_version() {
  // @@protoc_insertion_point(field_release:xaya.proto.SignedData.for_testing_version)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xaya.proto.SignedData.for_testing_version)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_gamechannel_2fproto_2fsignatures_2eproto
