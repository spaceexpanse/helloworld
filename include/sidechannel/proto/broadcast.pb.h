...
// source: sidechannel/proto/broadcast.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fbroadcast_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fbroadcast_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_sidechannel_2fproto_2fbroadcast_2eproto
...
struct TableStruct_sidechannel_2fproto_2fbroadcast_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sidechannel_2fproto_2fbroadcast_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::spacexpanse::proto::BroadcastMessage* Arena::CreateMaybeMessage<::spacexpanse::proto::BroadcastMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace spacexpanse {
namespace proto {
...
class BroadcastMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:spacexpanse.proto.BroadcastMessage) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "spacexpanse.proto.BroadcastMessage";
  }
  protected:
  ...
  // optional .spacexpanse.proto.StateProof proof = 2;
  bool has_proof() const;
  private:
  bool _internal_has_proof() const;
  public:
  void clear_proof();
  const ::spacexpanse::proto::StateProof& proof() const;
  PROTOBUF_NODISCARD ::spacexpanse::proto::StateProof* release_proof();
  ::spacexpanse::proto::StateProof* mutable_proof();
  void set_allocated_proof(::spacexpanse::proto::StateProof* proof);
  private:
  const ::spacexpanse::proto::StateProof& _internal_proof() const;
  ::spacexpanse::proto::StateProof* _internal_mutable_proof();
  public:
  void unsafe_arena_set_allocated_proof(
      ::spacexpanse::proto::StateProof* proof);
  ::spacexpanse::proto::StateProof* unsafe_arena_release_proof();

  // @@protoc_insertion_point(class_scope:spacexpanse.proto.BroadcastMessage)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::spacexpanse::proto::StateProof* proof_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_sidechannel_2fproto_2fbroadcast_2eproto;
};
// ===================================================================
...
inline const std::string& BroadcastMessage::reinit() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.BroadcastMessage.reinit)
...
void BroadcastMessage::set_reinit(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.reinit_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:spacexpanse.proto.BroadcastMessage.reinit)
}
inline std::string* BroadcastMessage::mutable_reinit() {
  std::string* _s = _internal_mutable_reinit();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.BroadcastMessage.reinit)
  return _s;
}
...
inline std::string* BroadcastMessage::release_reinit() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.BroadcastMessage.reinit)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.BroadcastMessage.reinit)
}
...
inline const ::spacexpanse::proto::StateProof& BroadcastMessage::_internal_proof() const {
  const ::spacexpanse::proto::StateProof* p = _impl_.proof_;
  return p != nullptr ? *p : reinterpret_cast<const ::spacexpanse::proto::StateProof&>(
      ::spacexpanse::proto::_StateProof_default_instance_);
}
inline const ::spacexpanse::proto::StateProof& BroadcastMessage::proof() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.BroadcastMessage.proof)
...
inline void BroadcastMessage::unsafe_arena_set_allocated_proof(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:spacexpanse.proto.BroadcastMessage.proof)
}
inline ::spacexpanse::proto::StateProof* BroadcastMessage::release_proof() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::spacexpanse::proto::StateProof* temp = _impl_.proof_;
...
inline ::spacexpanse::proto::StateProof* BroadcastMessage::unsafe_arena_release_proof() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.BroadcastMessage.proof)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::spacexpanse::proto::StateProof* temp = _impl_.proof_;
  _impl_.proof_ = nullptr;
  return temp;
}
inline ::spacexpanse::proto::StateProof* BroadcastMessage::_internal_mutable_proof() {
  _impl_._has_bits_[0] |= 0x00000002u;
  if (_impl_.proof_ == nullptr) {
    auto* p = CreateMaybeMessage<::spacexpanse::proto::StateProof>(GetArenaForAllocation());
    _impl_.proof_ = p;
  }
  return _impl_.proof_;
}
inline ::spacexpanse::proto::StateProof* BroadcastMessage::mutable_proof() {
  ::spacexpanse::proto::StateProof* _msg = _internal_mutable_proof();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.BroadcastMessage.proof)
  return _msg;
}
inline void BroadcastMessage::set_allocated_proof(::spacexpanse::proto::StateProof* proof) {
  ...
  _impl_.proof_ = proof;
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.BroadcastMessage.proof)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fbroadcast_2eproto
