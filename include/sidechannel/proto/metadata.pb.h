...
// source: sidechannel/proto/metadata.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fmetadata_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fmetadata_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_sidechannel_2fproto_2fmetadata_2eproto
...
struct TableStruct_sidechannel_2fproto_2fmetadata_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sidechannel_2fproto_2fmetadata_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::spacexpanse::proto::ChannelMetadata* Arena::CreateMaybeMessage<::spacexpanse::proto::ChannelMetadata>(Arena*);
template<> ::spacexpanse::proto::ChannelParticipant* Arena::CreateMaybeMessage<::spacexpanse::proto::ChannelParticipant>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace spacexpanse {
namespace proto {
...
class ChannelParticipant final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:spacexpanse.proto.ChannelParticipant) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "spacexpanse.proto.ChannelParticipant";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:spacexpanse.proto.ChannelParticipant)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_sidechannel_2fproto_2fmetadata_2eproto;
};
// -------------------------------------------------------------------

class ChannelMetadata final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:spacexpanse.proto.ChannelMetadata) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "spacexpanse.proto.ChannelMetadata";
  }
  protected:
  ...
  // repeated .spacexpanse.proto.ChannelParticipant participants = 1;
  int participants_size() const;
  private:
  int _internal_participants_size() const;
  public:
  void clear_participants();
  ::spacexpanse::proto::ChannelParticipant* mutable_participants(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::spacexpanse::proto::ChannelParticipant >*
      mutable_participants();
  private:
  const ::spacexpanse::proto::ChannelParticipant& _internal_participants(int index) const;
  ::spacexpanse::proto::ChannelParticipant* _internal_add_participants();
  public:
  const ::spacexpanse::proto::ChannelParticipant& participants(int index) const;
  ::spacexpanse::proto::ChannelParticipant* add_participants();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::spacexpanse::proto::ChannelParticipant >&
      participants() const;
  ...
  // @@protoc_insertion_point(class_scope:spacexpanse.proto.ChannelMetadata)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::spacexpanse::proto::ChannelParticipant > participants_;
...
inline const std::string& ChannelParticipant::name() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.ChannelParticipant.name)
...
void ChannelParticipant::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:spacexpanse.proto.ChannelParticipant.name)
}
inline std::string* ChannelParticipant::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.ChannelParticipant.name)
  return _s;
}
...
inline std::string* ChannelParticipant::release_name() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.ChannelParticipant.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.ChannelParticipant.name)
}
...
inline const std::string& ChannelParticipant::address() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.ChannelParticipant.address)
...
void ChannelParticipant::set_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:spacexpanse.proto.ChannelParticipant.address)
}
inline std::string* ChannelParticipant::mutable_address() {
  std::string* _s = _internal_mutable_address();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.ChannelParticipant.address)
  return _s;
}
...
inline std::string* ChannelParticipant::release_address() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.ChannelParticipant.address)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.ChannelParticipant.address)
}
...
inline ::spacexpanse::proto::ChannelParticipant* ChannelMetadata::mutable_participants(int index) {
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.ChannelMetadata.participants)
  return _impl_.participants_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::spacexpanse::proto::ChannelParticipant >*
ChannelMetadata::mutable_participants() {
  // @@protoc_insertion_point(field_mutable_list:spacexpanse.proto.ChannelMetadata.participants)
  return &_impl_.participants_;
}
inline const ::spacexpanse::proto::ChannelParticipant& ChannelMetadata::_internal_participants(int index) const {
  return _impl_.participants_.Get(index);
}
inline const ::spacexpanse::proto::ChannelParticipant& ChannelMetadata::participants(int index) const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.ChannelMetadata.participants)
  return _internal_participants(index);
}
inline ::spacexpanse::proto::ChannelParticipant* ChannelMetadata::_internal_add_participants() {
  return _impl_.participants_.Add();
}
inline ::spacexpanse::proto::ChannelParticipant* ChannelMetadata::add_participants() {
  ::spacexpanse::proto::ChannelParticipant* _add = _internal_add_participants();
  // @@protoc_insertion_point(field_add:spacexpanse.proto.ChannelMetadata.participants)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::spacexpanse::proto::ChannelParticipant >&
ChannelMetadata::participants() const {
  // @@protoc_insertion_point(field_list:spacexpanse.proto.ChannelMetadata.participants)
  return _impl_.participants_;
}
...
inline const std::string& ChannelMetadata::reinit() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.ChannelMetadata.reinit)
...
void ChannelMetadata::set_reinit(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.reinit_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:spacexpanse.proto.ChannelMetadata.reinit)
}
inline std::string* ChannelMetadata::mutable_reinit() {
  std::string* _s = _internal_mutable_reinit();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.ChannelMetadata.reinit)
  return _s;
}
...
inline std::string* ChannelMetadata::release_reinit() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.ChannelMetadata.reinit)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.ChannelMetadata.reinit)
}
...
inline const std::string& ChannelMetadata::custom() const {
  // @@protoc_insertion_point(field_get:spacexpanse.proto.ChannelMetadata.custom)
...
void ChannelMetadata::set_custom(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.custom_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:spacexpanse.proto.ChannelMetadata.custom)
}
inline std::string* ChannelMetadata::mutable_custom() {
  std::string* _s = _internal_mutable_custom();
  // @@protoc_insertion_point(field_mutable:spacexpanse.proto.ChannelMetadata.custom)
  return _s;
}
...
inline std::string* ChannelMetadata::release_custom() {
  // @@protoc_insertion_point(field_release:spacexpanse.proto.ChannelMetadata.custom)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:spacexpanse.proto.ChannelMetadata.custom)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_sidechannel_2fproto_2fmetadata_2eproto
